...
db:
  driver: "postgres"
  dsn: "postgres://postgres:postgres@127.0.0.1:5432/camellia_harvest?sslmode=disable"
  max_open_conns: 22
  max_idle_conns: 11
...
`
	...
	if cfg.DB.DSN != "postgres://postgres:postgres@127.0.0.1:5432/camellia_harvest?sslmode=disable" {
