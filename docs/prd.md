...
1. `recognition`：识别油茶果位置、成熟度、可采判断和采摘建议基线。
...
2. 前端通过网关 WebSocket 接收识别结果，展示成熟度汇总和采摘建议基线。
...
- 果实位置
- 成熟度标签：`green / half / red / young`
- 会话级成熟度汇总
- 采摘建议基线：`not_ready / partially_ready / ready / overripe_risk`
...
- `shared/constants/ripeness.json`：成熟度颜色映射
